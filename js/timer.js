 class PomodoroTimer {
            constructor() {
                ...
                this.statusDisplay = document.querySelector('.timer-hero__status');
                this.modeButtons = document.querySelectorAll('[data-timer-mode]');
                this.playBtn = document.querySelector('.timer-hero__btn--start');
                this.pauseBtn = document.querySelector('.timer-hero__btn--pause');
                this.resetBtn = document.querySelector('.timer-hero__btn--reset');
                this.settingsBtn = document.querySelector('.timer-hero__btn--settings');
            ...
            switchMode(mode) {
                ...
                if (this.statusDisplay) {
                    this.statusDisplay.textContent = this.getModeLabel(mode);
                }
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // to rask  notification permission on first interaction with site
